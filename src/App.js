      ...
      <div className="objective">
        ...
        <div className="objective__paragraph">
          <p>
            ...
            Heroku에 배포한 경험을 가지고 있습니다. DB는 MySQL과 MongoDB를 주로
            사용했고 AWS S3를 활용한 경험이 있습니다. 현재는 Docker, GraphQL,
            Go를 공부하고 있습니다.
          </p>
        </div>
      </div>
        ...
        <div className="project">
          ...
          <div className="project__paragraph">
            <p>
              ...
              소장하고 관리하며 볼 수 있는 웹사이트입니다. 주요 기능은 회원가입,
              로그인, 로그아웃, 영상업로드 등입니다. 백엔드는 NodeJS, Express로
              개발했고 데이터 베이스는 MongoDB를 활용했습니다. 백엔드 배포는
              Heroku로 업로드된 상태입니다. 프런트의 경우 React로 개발했습니다.
            </p>
          </div>
